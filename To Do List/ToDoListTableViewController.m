...
- (void) loadInitialData {
    ...
    item2.itemName = @"Go running";
    [self.toDoItems addObject:item2];
    ToDoItem *item3 = [[ToDoItem alloc] init];
    item3.itemName = @"Get coffee for boss";
...
- (IBAction)unwindToList:(UIStoryboardSegue *)segue {
    ...
    ToDoItem *toDoItem = sourceController.toDoItem;
    if (toDoItem != nil) {
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    tappedItem.completed = !tappedItem.completed;  // toggle completion
